...
Chances are you'll want to scroll some source other than the default dataStore to infinity. You can do that by injecting it to the route and specify the store in the infinityModel options:
