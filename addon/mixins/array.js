...
/**
  The Ember Infinity Array Mixin enables a RecordArray to control the loading of additional records

  @class ArrayMixin
  @namespace EmberInfinity
  @module ember-infinity/mixins/array
  @extends Ember.Mixin
*/
const ArrayMixin = Ember.Mixin.create({
